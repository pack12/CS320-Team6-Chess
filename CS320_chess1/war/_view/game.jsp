	...
	<body style= "background-color:slategrey">
		...
		<!--b8-->
				<div class="div2" id="b8" ondrop="drop(event)" ondragover="allowDrop(event)">
					<img src="Images/Chess_black_knight.png" alt="Black Queen" draggable="true" ondragstart="drag(event)" ondrop="drop(event)" ondragover="allowDrop(event)" id="bKnight1" width="60" height="60"/>
				</div>
		<!--c8-->
				<div class="div1" id="c8" ondrop="drop(event)" ondragover="allowDrop(event)">
					<img src="Images/Chess_black_bishop.png" alt="Black Queen" draggable="true" ondragstart="drag(event)" ondrop="drop(event)" ondragover="allowDrop(event)" id="bBishop1" width="60" height="60"/>
				</div>
		<!--d8-->
				<div class="div2" id="d8" ondrop="drop(event)" ondragover="allowDrop(event)">
					<img src="Images/Chess_black_king.png" alt="Black Queen" draggable="true" ondragstart="drag(event)" ondrop="drop(event)" ondragover="allowDrop(event)" id="bKing" width="60" height="60"/>
				</div>
		<!--e8-->
				<div class="div1" id="e8" ondrop="drop(event)" ondragover="allowDrop(event)">
					<img src="Images/Chess_black_queen.png" alt="Black Queen" draggable="true" ondragstart="drag(event)" ondrop="drop(event)" ondragover="allowDrop(event)" id="bQueen" width="60" height="60"/>
				</div>
		<!--f8-->
				<div class="div2" id="f8" ondrop="drop(event)" ondragover="allowDrop(event)">
					<img src="Images/Chess_black_bishop.png" alt="Black Queen" draggable="true" ondragstart="drag(event)" ondrop="drop(event)" ondragover="allowDrop(event)" id="bBishop2" width="60" height="60"/>
				</div>
		<!--g8-->
				<div class="div1" id="g8" ondrop="drop(event)" ondragover="allowDrop(event)">
					<img src="Images/Chess_black_knight.png" alt="Black Queen" draggable="true" ondragstart="drag(event)" ondrop="drop(event)" ondragover="allowDrop(event)" id="bKnight2" width="60" height="60"/>
				</div>
		<!--h8-->
				<div class="div2" id="h8" ondrop="drop(event)" ondragover="allowDrop(event)">
					<img src="Images/Chess_black_rook.png" alt="Black Queen" draggable="true" ondragstart="drag(event)" ondrop="drop(event)" ondragover="allowDrop(event)" id="bRook2" width="60" height="60"/>
				</div> <br>
		<!--a7-->
		...
		<!--c7-->
				<div class="div2" id="c7" ondrop="drop(event)" ondragover="allowDrop(event)">
					<img src="Images/Chess_black_pawn.png" alt="Black Queen" draggable="true" ondragstart="drag(event)" ondrop="drop(event)" ondragover="allowDrop(event)" id="bPawn3" width="60" height="60"/>
				</div>
		<!--d7-->
				<div class="div1" id="d7" ondrop="drop(event)" ondragover="allowDrop(event)">
					<img src="Images/Chess_black_pawn.png" alt="Black Queen" draggable="true" ondragstart="drag(event)" ondrop="drop(event)" ondragover="allowDrop(event)" id="bPawn4" width="60" height="60"/>
				</div>
		<!--e7-->
				<div class="div2" id="e7" ondrop="drop(event)" ondragover="allowDrop(event)">
					<img src="Images/Chess_black_pawn.png" alt="Black Queen" draggable="true" ondragstart="drag(event)" ondrop="drop(event)" ondragover="allowDrop(event)" id="bPawn5" width="60" height="60"/>
				</div>
		<!--f7-->
				<div class="div1" id="f7" ondrop="drop(event)" ondragover="allowDrop(event)">
					<img src="Images/Chess_black_pawn.png" alt="Black Queen" draggable="true" ondragstart="drag(event)" ondrop="drop(event)" ondragover="allowDrop(event)" id="bPawn6" width="60" height="60"/>
				</div>
		<!--g7-->
				<div class="div2" id="g7" ondrop="drop(event)" ondragover="allowDrop(event)">
					<img src="Images/Chess_black_pawn.png" alt="Black Queen" draggable="true" ondragstart="drag(event)" ondrop="drop(event)" ondragover="allowDrop(event)" id="bPawn7" width="60" height="60"/>
				</div>
		<!--h7-->
				<div class="div1" id="h7" ondrop="drop(event)" ondragover="allowDrop(event)">
					<img src="Images/Chess_black_pawn.png" alt="Black Queen" draggable="true" ondragstart="drag(event)" ondrop="drop(event)" ondragover="allowDrop(event)" id="bPawn8" width="60" height="60"/>
				</div> 
		<br>
		<!--a6-->
		...
		<!--a2-->
				<div class="div1" id="a2" ondrop="drop(event)" ondragover="allowDrop(event)">
					<img src="Images/Chess_white_pawn.png" alt="Black Queen" draggable="true" ondragstart="drag(event)" ondrop="drop(event)" ondragover="allowDrop(event)" id="wPawn1" width="60" height="60"/>
				</div>
		<!--b2-->
				<div class="div2" id="b2" ondrop="drop(event)" ondragover="allowDrop(event)">
					<img src="Images/Chess_white_pawn.png" alt="Black Queen" draggable="true" ondragstart="drag(event)" ondrop="drop(event)" ondragover="allowDrop(event)" id="wPawn2" width="60" height="60"/>
				</div>
		<!--c2-->
				<div class="div1" id="c2" ondrop="drop(event)" ondragover="allowDrop(event)">
					<img src="Images/Chess_white_pawn.png" alt="Black Queen" draggable="true" ondragstart="drag(event)" ondrop="drop(event)" ondragover="allowDrop(event)" id="wPawn3" width="60" height="60"/>
				</div>
		<!--d2-->
				<div class="div2" id="d2" ondrop="drop(event)" ondragover="allowDrop(event)">
					<img src="Images/Chess_white_pawn.png" alt="Black Queen" draggable="true" ondragstart="drag(event)" ondrop="drop(event)" ondragover="allowDrop(event)" id="wPawn4" width="60" height="60"/>
				</div>
		<!--e2-->
				<div class="div1" id="e2" ondrop="drop(event)" ondragover="allowDrop(event)">
					<img src="Images/Chess_white_pawn.png" alt="Black Queen" draggable="true" ondragstart="drag(event)" ondrop="drop(event)" ondragover="allowDrop(event)" id="wPawn5" width="60" height="60"/>
				</div>
		<!--f2-->
				<div class="div2" id="f2" ondrop="drop(event)" ondragover="allowDrop(event)">
					<img src="Images/Chess_white_pawn.png" alt="Black Queen" draggable="true" ondragstart="drag(event)" ondrop="drop(event)" ondragover="allowDrop(event)" id="wPawn6" width="60" height="60"/>
				</div>
		<!--g2-->
				<div class="div1" id="g2" ondrop="drop(event)" ondragover="allowDrop(event)">
					<img src="Images/Chess_white_pawn.png" alt="Black Queen" draggable="true" ondragstart="drag(event)" ondrop="drop(event)" ondragover="allowDrop(event)" id="wPawn7" width="60" height="60"/>
				</div>
		<!--h2-->
				<div class="div2" id="h2" ondrop="drop(event)" ondragover="allowDrop(event)">
					<img src="Images/Chess_white_pawn.png" alt="Black Queen" draggable="true" ondragstart="drag(event)" ondrop="drop(event)" ondragover="allowDrop(event)" id="wPawn8" width="60" height="60"/>
				</div> <br>
		<!--a1-->
				<div class="div2" id="a1" ondrop="drop(event)" ondragover="allowDrop(event)">
					<img src="Images/Chess_white_rook.png" alt="Black Queen" draggable="true" ondragstart="drag(event)" ondrop="drop(event)" ondragover="allowDrop(event)" id="wRook1" width="60" height="60"/>
				</div>
		<!--b1-->
				<div class="div1" id="b1" ondrop="drop(event)" ondragover="allowDrop(event)">
					<img src="Images/Chess_white_knight.png" alt="Black Queen" draggable="true" ondragstart="drag(event)" ondrop="drop(event)" ondragover="allowDrop(event)" id="wKnight1" width="60" height="60"/>
				</div>
		<!--c1-->
				<div class="div2" id="c1" ondrop="drop(event)" ondragover="allowDrop(event)">
					<img src="Images/Chess_white_bishop.png" alt="Black Queen" draggable="true" ondragstart="drag(event)" ondrop="drop(event)" ondragover="allowDrop(event)" id="wBishop1" width="60" height="60"/>
				</div>
		<!--d1-->
				<div class="div1" id="d1" ondrop="drop(event)" ondragover="allowDrop(event)">
					<img src="Images/Chess_white_queen.png" alt="Black Queen" draggable="true" ondragstart="drag(event)" ondrop="drop(event)" ondragover="allowDrop(event)" id="wQueen" width="60" height="60"/>
				</div>
		<!--e1-->
				<div class="div2" id="e1" ondrop="drop(event)" ondragover="allowDrop(event)">
					<img src="Images/Chess_white_king.png" alt="Black Queen" draggable="true" ondragstart="drag(event)" ondrop="drop(event)" ondragover="allowDrop(event)" id="wKing" width="60" height="60"/>
				</div>
		<!--f1-->
				<div class="div1" id="f1" ondrop="drop(event)" ondragover="allowDrop(event)">
					<img src="Images/Chess_white_bishop.png" alt="Black Queen" draggable="true" ondragstart="drag(event)" ondrop="drop(event)" ondragover="allowDrop(event)" id="wBishop2" width="60" height="60"/>
				</div>
		<!--g1-->
				<div class="div2" id="g1" ondrop="drop(event)" ondragover="allowDrop(event)">
					<img src="Images/Chess_white_knight.png" alt="Black Queen" draggable="true" ondragstart="drag(event)" ondrop="drop(event)" ondragover="allowDrop(event)" id="wKnight2" width="60" height="60"/>
				</div>
		<!--h1-->
				<div class="div1" id="h1" ondrop="drop(event)" ondragover="allowDrop(event)">
					<img src="Images/Chess_white_rook.png" alt="Black Queen" draggable="true" ondragstart="drag(event)" ondrop="drop(event)" ondragover="allowDrop(event)" id="wRook2" width="60" height="60"/>
				</div>
